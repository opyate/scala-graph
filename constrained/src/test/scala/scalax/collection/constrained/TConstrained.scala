  ...
  with    ShouldMatchers
{
  ...
  def test_EvenNodeByException {
    import UserConstraints.EvenNodeByException
    intercept[IllegalArgumentException] {
            factory(EvenNodeByException)(1,2,3,4)
    }
    val g = factory(EvenNodeByException)(2,4)
  ...
  def test_Op {
    ...
    val g1 = factory(EvenNode && EvenNode)(2,4)
    g1 should have ('order (2), 'graphSize (0))

    val g2 = factory.empty[Int,UnDiEdge](EvenNode && MinDegree_2)
